...
| Final Sentinel | Kant | `reports/v28/final_sentinel_review.*` only | whole repository and PR #10 | none | exact-head validation | read-only | 5 | historical FAIL; fresh review pending |
