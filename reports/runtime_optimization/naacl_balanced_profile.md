...
The validator also records digests for the Q3 alias map, Q3 budget protocol, Q2 protocol, and locked seed source. It checks the retained aliases, XLM-R and budgets `64`/`256` exclusions, all three seeds, and the 36-cell Q3 Cartesian count against those sources.
