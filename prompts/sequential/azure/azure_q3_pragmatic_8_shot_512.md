...
4. Run that locked sequence with `python scripts/run_single_azure_job.py --job-id azure_q3_pragmatic_8_shot_512 --stage all`.
5. On interruption, resume only this job with `python scripts/run_single_azure_job.py --job-id azure_q3_pragmatic_8_shot_512 --resume`.
