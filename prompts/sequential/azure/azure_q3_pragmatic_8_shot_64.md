...
3. After preflight passes, run `python scripts/run_single_azure_job.py --job-id azure_q3_pragmatic_8_shot_64 --stage all`.
4. On interruption, resume only this job with `python scripts/run_single_azure_job.py --job-id azure_q3_pragmatic_8_shot_64 --resume`.
