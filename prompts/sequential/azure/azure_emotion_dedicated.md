...
4. Run that locked sequence with `python scripts/run_single_azure_job.py --job-id azure_emotion_dedicated --stage all`.
5. On interruption, resume only this job with `python scripts/run_single_azure_job.py --job-id azure_emotion_dedicated --resume`.
