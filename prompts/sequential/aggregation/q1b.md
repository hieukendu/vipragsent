# ViPragSent approved-run aggregation: Q1b

This runbook aggregates only completed, explicitly approved sequential runs for `Q1b`. It does not train, download models, call Azure, approve runs, or start another run.

## Required command

Run:

`python scripts/aggregate_approved_runs.py --research-question Q1b`
