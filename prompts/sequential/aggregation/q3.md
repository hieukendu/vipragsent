# ViPragSent approved-run aggregation: Q3

This runbook aggregates only completed, explicitly approved sequential runs for `Q3`. It does not train, download models, call Azure, approve runs, or start another run.

## Required command

Run:

`python scripts/aggregate_approved_runs.py --research-question Q3`
