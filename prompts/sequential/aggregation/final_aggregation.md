# ViPragSent approved-run aggregation: all research questions

This runbook aggregates only completed, explicitly approved sequential runs for `all research questions`. It does not train, download models, call Azure, approve runs, or start another run.

## Required command

Run:

`python scripts/aggregate_approved_runs.py --research-question all`
