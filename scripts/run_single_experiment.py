...
def main() -> int:
    ...
    parser.add_argument("--stage", choices=("preflight", "train", "train_or_reuse", "train_or_run", "execute_components", "combine_component_predictions", "evaluate_dev", "freeze_selection", "freeze_component_selection", "evaluate_test", "train_generation", "generate_dev_reasoning", "judge_dev_reasoning", "compute_dev_reasoning_metrics", "freeze_selection", "generate_test_reasoning", "judge_test_reasoning", "compute_test_reasoning_metrics", "generate_dev_reasoning_from_rationale_decoder", "generate_test_reasoning_from_rationale_decoder", "validate_source_checkpoint", "resolve_approved_full_vistral_source", "generate_dev", "parse_dev", "generate_test", "parse_test", "resolve_approved_source", "evaluate_external_tests", "evaluate_reused_test", "validate_source_predictions", "extract_pragmatic_calibration", "extract_learning_history", "export_artifacts", "validate_artifacts", "generate_review_summary", "all"), default="all")
